...
import { jobTypeOptions, industriesOptions, experienceOptions, educationOptions } from './data';
...
const NewJob = ({ access_token }) => {
    ...
    const { clearErrors, error, loading, created, setCreated, newJob } = useContext(JobContext)
                ...
                <form className="form" onSubmit={submitHandler}>
                    <div className="row">
                        ...
                        <div className="col-12 col-md-6 ml-4 mt-4 mt-md-0 ml-md-0">
                            ...
                            <div className="boxWrapper">
                                <h4>Experience:</h4>
                                <div className="selectWrapper" value={experience} onChange={e => setExperience(e.target.value)}>
