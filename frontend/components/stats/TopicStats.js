...
const TopicStats = () => {
    ...
    const { loading, error, clearErrors, stats, getTopicStats } = useContext(JobContext)
                            ...
                            stats && stats.message ? (
                                ...
                                <>
                                    ...
                                    <table className="table table-striped mt-4">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><BiRupee />{stats.min_salary}</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Maximum Salary</th>
                                                <td><BiRupee />{stats.max_salary}</td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Average Salary</th>
                                                <td><BiRupee />{stats.avg_salary}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    ...
                                    <div className="alert alert-danger mt-4">
                                        ...
                                        posted only on Jobbie. Do not compare these stats with other
                                        sites.
                                    </div>
                                </>
                            ))
